Shader "Grass/PointGrass/PointGrassRotate"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            void geom(point v2g IN[1], inout TriangleStream<g2f> triStream)
            {
                ...
                //define identity vectors for use in movement.
                ...
                //Rotate grass-tip around each axis individually.
                pos[0] = float4(rotateAroundX(pos[0] - center, angleToRad(_RotX)) + center, 1);
                pos[0] = float4(rotateAroundY(pos[0] - center, angleToRad(_RotY)) + center, 1);
                pos[0] = float4(rotateAroundZ(pos[0] - center, angleToRad(_RotZ)) + center, 1);
